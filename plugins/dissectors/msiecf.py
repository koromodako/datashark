...
#  CLASSES
# =============================================================================
class MSIECFDissector(Dissector):
    '''MSIECFDissector
    '''
    ...
    def supported_mime_types(self):
        ...
        '''
        self.logger.todo("implement MSIECFDissector.supported_mime_types() method.")
    ...
    def can_dissect(self, container):
        ...
        Arguments:
            container {Container} -- Container to check for dissection
                                     compatibility
        '''
        self.logger.todo("implement MSIECFDissector.can_dissect() method.")
    ...
    def containers(self, container):
        ...
        '''
        self.logger.todo("implement MSIECFDissector.containers() method.")
