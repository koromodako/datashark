...
class VMDKDissector(Dissector):
    ...
    def supported_mime_types(self):
        ...
        '''
        self.logger.todo("implement VMDKDissector.supported_mime_types() method.")
    ...
    def can_dissect(self, container):
        ...
        Arguments:
            container {Container} -- Container to check for dissection
                                     compatibility
        '''
        self.logger.todo("implement VMDKDissector.can_dissect() method.")
    ...
    def containers(self, container):
        ...
        '''
        self.logger.todo("implement VMDKDissector.containers() method.")
