...
class REGFDissector(Dissector):
    ...
    def supported_mime_types(self):
        ...
        '''
        self.logger.todo("implement REGFDissector.supported_mime_types() method.")
    ...
    def can_dissect(self, container):
        ...
        Arguments:
            container {Container} -- Container to check for dissection
                                     compatibility
        '''
        self.logger.todo("implement REGFDissector.can_dissect() method.")
    ...
    def containers(self, container):
        ...
        '''
        self.logger.todo("implement REGFDissector.containers() method.")
