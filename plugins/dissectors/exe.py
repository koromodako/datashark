...
class EXEDissector(Dissector):
    ...
    def supported_mime_types(self):
        ...
        '''
        self.logger.todo("implement EXEDissector.supported_mime_types() method.")
    ...
    def can_dissect(self, container):
        ...
        Arguments:
            container {Container} -- Container to check for dissection
                                     compatibility
        '''
        self.logger.todo("implement EXEDissector.can_dissect() method.")
    ...
    def containers(self, container):
        ...
        '''
        self.logger.todo("implement EXEDissector.containers() method.")
