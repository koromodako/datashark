...
#  CLASSES
# =============================================================================
class OLECFDissector(Dissector):
    '''OLECFDissector
    '''
    ...
    def supported_mime_types(self):
        ...
        '''
        self.logger.todo("implement OLECFDissector.supported_mime_types() method.")
    ...
    def can_dissect(self, container):
        ...
        Arguments:
            container {Container} -- Container to check for dissection
                                     compatibility
        '''
        self.logger.todo("implement OLECFDissector.can_dissect() method.")
    ...
    def containers(self, container):
        ...
        '''
        self.logger.todo("implement OLECFDissector.containers() method.")
